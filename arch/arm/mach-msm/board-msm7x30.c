...
#endif //CONFIG_PMIC8058_VIBRATOR
...
#include "./qdsp5v2/sky_snd_ext_amp_max97001.h"
#endif
#ifdef CONFIG_INPUT_SENSOR
#include "msm7x30-sky-sensor.h"
#endif

#ifdef CONFIG_WIFI_CONTROL_FUNC  // 20110717 hskim_wifi for BCM4329_PLATFORM
#include <linux/wlan_plat.h>
#endif

// novapex_hsj_20110825__PMEM_ALLOC_FAIL
...
#if defined(CONFIG_MACH_MSM8X55_EF30S) || defined(CONFIG_MACH_MSM8X55_EF18K)  //p12911 shs
#define PMIC_GPIO_SDC4_EN_N	17  /* PMIC GPIO Number 18 */
#else
#define PMIC_GPIO_SDC4_EN_N 24  /* PMIC GPIO Number 25*/ /*yjw 20110420*/
#endif
...
#if defined(CONFIG_MACH_MSM8X55_EF30S) || defined(CONFIG_MACH_MSM8X55_EF18K)  // #if (MODEL_ID == MODEL_EF18K) // 20100909, kkcho, for EF18K BL
#define LCD_BL_I2C_CONTROL
#endif

#if defined(CONFIG_MACH_MSM8X55_EF30S) || defined(CONFIG_MACH_MSM8X55_EF18K)  //EF18K, EF30S
...
#ifdef CONFIG_SKY_SND_EXTAMP
#define GPIO_PIN_SUBSYSTEM_SCL	175
#define GPIO_PIN_SUBSYSTEM_SDA	176
...
//GPIO not QUP
#define GPIO_PIN_TDMB_SCL	0
#define GPIO_PIN_TDMB_SDA	1
...
#ifdef CONFIG_KEYBOARD_PMIC8058  // PS2 P13106 KANG YOONKOO
...
static struct i2c_board_info i2c_led_devices[] __initdata = {
	{
		I2C_BOARD_INFO("SC620", 0xE0 >> 1)  // 11100000
	},
};
#endif /*LCD_BL_I2C_CONTROL*/
...
#endif
#ifdef CONFIG_PANTECH_CAMERA_YACBAC1S
	{
...
static uint32_t camera_on_gpio_table[] = {
	...
	/* Increase MCLK stength to get more rectangular waveform. */
...
#ifdef CONFIG_SKY_SND_EXTAMP
void sky_snddev_hsed_speaker_pamp_on(void)
{
	int rc;
	snddev_vreg_ncp = vreg_get(NULL, "ncp");
	if (IS_ERR(snddev_vreg_ncp)) {
...
void sky_snddev_hsed_speaker_pamp_off(void)
{
	int rc;
...
void sky_snddev_speaker_pamp_on(void)
{
        snd_extamp_api_SetDevice(1, SND_SKY_DEVICE_VT_SPEAKER_RX);
}

void sky_snddev_speaker_pamp_off(void)
{
        snd_extamp_api_SetDevice(0, SND_SKY_DEVICE_VT_SPEAKER_RX);
}

void sky_snddev_mute_rx_on(void)
{
        snd_extamp_api_SetDevice(1, SND_SKY_DEVICE_MUTE_RX);
}

void sky_snddev_mute_rx_off(void)
{
        snd_extamp_api_SetDevice(0, SND_SKY_DEVICE_MUTE_RX);
}

void sky_snddev_hsed_pamp_on(void)
{
	int rc;
	snddev_vreg_ncp = vreg_get(NULL, "ncp");
	if (IS_ERR(snddev_vreg_ncp)) {
	...
	if (rc)
        ...
        snd_extamp_api_SetDevice(1, SND_SKY_DEVICE_VOICE_HEADSET_RX);
}

void sky_snddev_hsed_pamp_off(void)
{
	int rc;
	if (IS_ERR(snddev_vreg_ncp)) {
		pr_err("%s: vreg_get(%s) failed (%ld)\n",
	...
	vreg_put(snddev_vreg_ncp);
        ...
        snd_extamp_api_SetDevice(0, SND_SKY_DEVICE_VOICE_HEADSET_RX);
}

void sky_snddev_poweramp_handset_on(void)
{
       snd_extamp_api_SetDevice(1, SND_DEVICE_HANDSET_RX);
}

void sky_snddev_poweramp_handset_off(void)
{
...
#ifndef CONFIG_MARIMBA_CODEC  //20110714 frogLove : gpio duplicated with tdmb
...
#if !defined(CONFIG_MACH_MSM8X55_EF18K) && !defined(CONFIG_MACH_MSM8X55_EF30S) // #if (MODEL_ID != MODEL_EF18K) // shpark 100423 no-uses
...
static struct android_usb_platform_data android_usb_pdata = {
	...
	.product_id	= 0x1104,
	.version	= 0x0100,
	.product_name		= PANTECH_MODEL_NAME,
...
#if !defined(CONFIG_MACH_MSM8X55_EF18K) && !defined(CONFIG_MACH_MSM8X55_EF30S) // #if (MODEL_ID != MODEL_EF18K) // shpark. not use optnav
...
#endif // (MODEL_ID != MODEL_EF18K)

#if !defined(CONFIG_MACH_MSM8X55_EF18K)  && !defined(CONFIG_MACH_MSM8X55_EF30S) // #if (MODEL_ID != MODEL_EF18K) // shpark
...
static struct platform_device android_pmem_ppp_device = {
	.name = "android_pmem",
	.id = 7,
	.dev = { .platform_data = &android_pmem_ppp_pdata },
};
#endif
...
// paiksun...
...
#else
	struct vreg *vreg_ldo16, *vreg_ldo8 = NULL;
#endif
    ...
    printk("%s :: LCD power on %d, %d\n", __func__, display_common_power_save_on, on);
	...
	if (on) {
		...
		if (rc) {
			pr_err("%s: pm8058_gpio_config(%#x)=%d\n",
					...
					rc);
/* 20101224, kkcho, EF18K에서 call-alert시 아래 사용되지 않는 PM-gpio pin error로 인해
    전원set을 하지 못하고 return되는 case발생. error 발생해도 return되지 않도록 .*/
			//return rc;
		}
...
#if !defined(CONFIG_MACH_MSM8X55_EF18K) && !defined(CONFIG_MACH_MSM8X55_EF30S) // #if (MODEL_ID != MODEL_EF18K) // shpark gp12 is used for touchscreen
...
#ifndef SKY_FAST_LCD_ON // 20101112, kkcho, for using the LCD_SLEEP_MODE              
              else {
...
#if !defined(CONFIG_MACH_MSM8X55_EF18K) // #if (MODEL_ID != MODEL_EF18K) // shpark gp12 is used for touchscreen
...
#else
static int display_common_power(int on)
#if defined(CONFIG_MACH_MSM8X55_EF30S)  // 20110114, kkcho, adjustment display-power
{
	int rc = 0, flag_on = !!on;
	static int display_common_power_save_on;
	struct vreg *vreg_ldo15 = NULL;
...
// novapex_hsj_20110808__overlay fail(from pantech_lks)
int mdp_core_clk_rate_table[] = {
#if 0	//Overlay Fail Problem, Don't use dynamic mdp clock.
	122880000,
	122880000,
	122880000,
	192000000,
...
static struct resource bluesleep_resources[] = {
	...
	{
		.name	= "host_wake",
		.start	= MSM_GPIO_TO_INT(142),
		.end	= MSM_GPIO_TO_INT(142),
		.flags	= IORESOURCE_IRQ,
	},
};
...
static unsigned bt_config_power_on[] = {
	GPIO_CFG(142, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* BT_WAKE_MSM / BT_HOST_WAKE : Maoint */
	GPIO_CFG(134, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* RFR */
	GPIO_CFG(135, 1, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* CTS */
	GPIO_CFG(136, 1, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* Rx */
	GPIO_CFG(137, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* Tx */
	GPIO_CFG(138, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_DOUT */
	GPIO_CFG(139, 1, GPIO_CFG_INPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_DIN */
	GPIO_CFG(140, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_SYNC */
	GPIO_CFG(141, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* PCM_CLK */
	GPIO_CFG(56, 0, GPIO_CFG_OUTPUT,  GPIO_CFG_NO_PULL, GPIO_CFG_2MA),		/* BT_WAKE_MSM / BT_EXT_WAKE*/
	GPIO_CFG(143,0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),	/* BT_SYSRST */
};

static unsigned bt_config_power_off[] = {
	GPIO_CFG(142, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* BT_WAKE_MSM / BT_HOST_WAKE : Maoint */
	GPIO_CFG(134, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* RFR */
	GPIO_CFG(135, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* CTS */
	GPIO_CFG(136, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* Rx */
	GPIO_CFG(137, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* Tx */
	...
	GPIO_CFG(56, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),	/* MSM_WAKE_BT / BT_EXT_WAKE */
	GPIO_CFG(143, 0, GPIO_CFG_INPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), 	/* BT_SYSRST */
};
...
static int bluetooth_power(int on)
{
	...
	if (on) {
		...
		gpio_set_value(143, on); /* BT_SYSRST */
		mdelay(10);
		gpio_set_value(143, 0); /* BT_SYSRST */
		mdelay(10);
		gpio_set_value(143, on); /* BT_SYSRST */
	} else {
		gpio_set_value(143, on); /* BT_SYSRST */
...
#if 0
        // use fuel gauge, not adc of battery voltage
	// If the level is more than 100%, the battery status bar is not displayed.
	if( current_voltage > 1000 )
		return 100;
	// Compensate the level, if more than 90%, because the level is 97% at full charged by charger.
	//완전충전해도 SOC가 100%가 아닌 97%까지만 올라감, 마진포함 95%가 100%로 되도록 보상
	else if(current_voltage > 900 ) 
	{
        	u32 result;
        	// y = 10/7 * x - 38.571
        	result = (current_voltage/5) - 90; //95%
        	//result = (current_voltage/7) - 38; //97%
        	return (result > 100) ? 100 : result;
	}
	// If the level is more than 0.1%, Not turn off power.
	else if( (current_voltage <25) && (current_voltage > 1) ) //if( (adjust_soc < 1) && (adjust_soc > -1.5))
		return 1;
	else if(current_voltage <= 1)
		return 0;
        else
	        return (current_voltage /10);
#endif            
...
#ifdef CONFIG_WIFI_CONTROL_FUNC // 20110717 hskim_wifi for wifi platform device
#ifdef CONFIG_WIFI_MEM_PREALLOC  // 20110717 hskim_wifi  for wifi platform device memory pre-alloc
...
#define GPIO_NO_WLAN_SHDN	55
#define GPIO_NO_WLAN_HOST_WAKE	68
...
static uint32_t wlan_on_gpio_cfgs[] = {
	/* WLAN_SHDN */
	GPIO_CFG(GPIO_NO_WLAN_SHDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
	/* WLAN_HOST_WAKE */
	GPIO_CFG(GPIO_NO_WLAN_HOST_WAKE, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};

static uint32_t wlan_off_gpio_cfgs[] = {
	/* WLAN_SHDN */
	GPIO_CFG(GPIO_NO_WLAN_SHDN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA),
	/* WLAN_HOST_WAKE */
	GPIO_CFG(GPIO_NO_WLAN_HOST_WAKE, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
};
...
static int wlan_power(int on)
{
	...
	if (on) {
		...
		mdelay(30);
   		gpio_set_value(GPIO_NO_WLAN_SHDN, on);
		mdelay(40);
...
static void msm7x30_wlan_init(void)
{
#ifdef CONFIG_WIFI_MEM_PREALLOC // 20110715 hskim_wifi for wifi platform device memory pre-alloc
	int rc = 0;
#endif
	wlan_power(0); 
...
static struct resource wlan_resources[] = {
	[0] = {
		...
		.start		= MSM_GPIO_TO_INT(GPIO_NO_WLAN_HOST_WAKE),
		.end		= MSM_GPIO_TO_INT(GPIO_NO_WLAN_HOST_WAKE),
		.flags		= IORESOURCE_IRQ | IORESOURCE_IRQ_LOWEDGE,	// 20110811 hskim_wifi for wifi sw_oob
//		.flags		= IORESOURCE_IRQ | IORESOURCE_IRQ_LOWLEVEL, // 20110811 hskim_wifi for not using wifi hw_oob
	},
};
...
#ifndef CONFIG_UART2DM_CONSOLE
	&msm_device_uart2,
#endif
#endif
	&msm_device_smd,
	&msm_device_dmov,
#if !defined(CONFIG_MACH_MSM8X55_EF18K)  && !defined(CONFIG_MACH_MSM8X55_EF30S) // #if (MODEL_ID != MODEL_EF18K) // shpark. no-uses
	&smc91x_device,
	&smsc911x_device,
#endif
	&msm_device_nand,
...
#ifndef CONFIG_MACH_MSM8X55_EF18K
...
static struct msm_gpio sdc4_cfg_data[] = {
	...
	{GPIO_CFG(59, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), "sdc4_cmd"},
	{GPIO_CFG(60, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), "sdc4_dat_3"},
	{GPIO_CFG(61, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), "sdc4_dat_2"},
	{GPIO_CFG(62, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), "sdc4_dat_1"},
	{GPIO_CFG(63, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_16MA), "sdc4_dat_0"},
};
#else
static struct msm_gpio sdc4_cfg_data[] = {
	{GPIO_CFG(58, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA), "sdc4_clk"},
...
#if 0 /*ndef CONFIG_SKY_WLAN 20110610 hskim_wifi for wifi_init  */
...
{
#if 1  /*def CONFIG_SKY_WLAN 20110610 hskim_wifi for wifi_init  */
	int rc = 0;

	if (gpio_request(55, "sdc2_wlan_reset"))
		pr_err("failed to request gpio sdc2_wlan_reset\n");
	rc = gpio_tlmm_config(GPIO_CFG(55, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL,
				GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	if (rc)
		printk(KERN_ERR "%s: Failed to configuration GPIO_55 %d\n",
				__func__, rc);

	if (gpio_request(68, "wifi_host_wake"))
		pr_err("failed to request wifi_host_wake\n");
	rc = gpio_tlmm_config(GPIO_CFG(68, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL,
				GPIO_CFG_8MA), GPIO_CFG_ENABLE);
	if (rc)
		printk(KERN_ERR "%s: Failed to configuration GPIO_68 %d\n",
				__func__, rc);	
#endif /* CONFIG_SKY_WLAN */
...
#if defined(CONFIG_MACH_MSM8X55_EF18K) ||  defined(CONFIG_MACH_MSM8X55_EF30S)// #if (MODEL_ID == MODEL_EF18K)
...
#ifdef LCD_BL_I2C_CONTROL
            //led_device_i2c_init();
        i2c_register_board_info(9, i2c_led_devices,
                    ARRAY_SIZE(i2c_led_devices));
#endif /* LCD_BL_I2C_CONTROL */   

#ifdef CONFIG_SKY_TDMB_I2C_CMD
//GPIO not QUP
    i2c_register_board_info(15, i2c_tdmb_devices,
...
MACHINE_START(MSM8X55_EF18K, "PANTECH MSM7X30 EF18K")
#ifdef CONFIG_MSM_DEBUG_UART
      .phys_io  = MSM_DEBUG_UART_PHYS,
      .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
...
MACHINE_START(MSM8X55_EF30S, "PANTECH MSM8X55 EF30S")
#ifdef CONFIG_MSM_DEBUG_UART
      .phys_io  = MSM_DEBUG_UART_PHYS,
      .io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
