...
typedef enum {
	...
	NV_SPARE_1_I = 107,
	NV_SPARE_2_I = 108,
	NV_WLAN_MAC_ADDRESS_I = 4678 	// 20110621 hskim_wifi for wifi mac address backup
	// add here 
} nv_items_enum_type;
...
// 20110621 hskim_wifi for wifi mac address backup
typedef struct { 
...
typedef  union {
	...
	uint32_t	spare_1;
	uint32_t	spare_2;
	uint32_t	wlan_mac_address[2]; 	// 20110621 hskim_wifi for wifi mac address backup
	// add here
} nv_cmd_item_type;
