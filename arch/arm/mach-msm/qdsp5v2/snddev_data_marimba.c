...
#ifdef CONFIG_SKY_SND_EXTAMP
	.pamp_on = &sky_snddev_poweramp_handset_on,
	.pamp_off = &sky_snddev_poweramp_handset_off,
#endif	
...
static enum hsed_controller ihset_mic_pmctl_id[] = {PM_HSED_CONTROLLER_1};
#endif
...
static struct snddev_icodec_data snddev_ihs_mono_tx_data = {
	...
	.channel_mode = 1,
#ifdef CONFIG_SKY_SND_CTRL
	.pmctl_id = ihset_mic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(ihset_mic_pmctl_id),
#else
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
#endif
...
static struct snddev_icodec_data snddev_ihs_stereo_speaker_stereo_rx_data = {
	...
	.default_sample_rate = 48000,
#ifdef CONFIG_SKY_SND_EXTAMP
	.pamp_on = &sky_snddev_hsed_speaker_pamp_on,
	.pamp_off = &sky_snddev_hsed_speaker_pamp_off,
	.voltage_on = NULL,
	.voltage_off = NULL,
#else
	.pamp_on = msm_snddev_poweramp_on,
...
#ifdef CONFIG_SKY_SND_CTRL   
static struct adie_codec_action_unit sky_vt_ispeaker_rx_48KHz_osr256_actions[] =
   SKY_VT_SPEAKER_STEREO_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_vt_ispeaker_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_vt_ispeaker_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_vt_ispeaker_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_vt_ispeaker_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = sky_vt_ispeaker_rx_settings,
	.setting_sz = ARRAY_SIZE(sky_vt_ispeaker_rx_settings),
};

static struct snddev_icodec_data sky_vt_snddev_ispeaker_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "sky_vt_speaker_stereo_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MONO,
	.profile = &sky_vt_ispeaker_rx_profile,
	.channel_mode = 2,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	.pamp_on = &sky_snddev_speaker_pamp_on,
	.pamp_off = &sky_snddev_speaker_pamp_off,
	.max_voice_rx_vol[VOC_NB_INDEX] = 900,
	.min_voice_rx_vol[VOC_NB_INDEX] = -1400,
	.max_voice_rx_vol[VOC_WB_INDEX] = 900,
	.min_voice_rx_vol[VOC_WB_INDEX] = -1400,
...
static struct platform_device sky_vt_msm_ispeaker_rx_device = {
	.name = "snddev_icodec",
	.id = 26,
	.dev = { .platform_data = &sky_vt_snddev_ispeaker_rx_data },

};


static struct adie_codec_action_unit sky_vt_ispeaker_tx_8KHz_osr256_actions[] =
	SKY_VT_SPEAKER_TX_8000_OSR_256;

static struct adie_codec_action_unit sky_vt_ispeaker_tx_48KHz_osr256_actions[] =
	SKY_VT_SPEAKER_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_vt_ispeaker_tx_settings[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = sky_vt_ispeaker_tx_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_vt_ispeaker_tx_8KHz_osr256_actions),
	},
	{ /* 8KHz profile is good for 16KHz */
		.freq_plan = 16000,
		.osr = 256,
	...
	},
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_vt_ispeaker_tx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_vt_ispeaker_tx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_vt_ispeaker_tx_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = sky_vt_ispeaker_tx_settings,
	.setting_sz = ARRAY_SIZE(sky_vt_ispeaker_tx_settings),
};

static enum hsed_controller sky_vt_ispk_pmctl_id[] = {PM_HSED_CONTROLLER_0};

static struct snddev_icodec_data sky_vt_snddev_ispeaker_tx_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "sky_vt_speaker_mono_tx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_SPKR_PHONE_MIC,
	.profile = &sky_vt_ispeaker_tx_profile,
	.channel_mode = 1,
	.pmctl_id = sky_vt_ispk_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(sky_vt_ispk_pmctl_id),
	.default_sample_rate = 48000,
#ifdef CONFIG_SKY_SND_EXTAMP
	.pamp_on = NULL,
	.pamp_off = NULL,
...
static struct platform_device sky_vt_msm_ispeaker_tx_device = {
	.name = "snddev_icodec",
	.id = 27,
	.dev = { .platform_data = &sky_vt_snddev_ispeaker_tx_data },
};



static struct adie_codec_action_unit sky_record_imic_8KHz_osr256_actions[] =
	SKY_RECORD_HANDSET_TX_8000_OSR_256;

static struct adie_codec_action_unit sky_record_imic_16KHz_osr256_actions[] =
	SKY_RECORD_HANDSET_TX_16000_OSR_256;

static struct adie_codec_action_unit sky_record_imic_48KHz_osr256_actions[] =
	SKY_RECORD_HANDSET_TX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_record_imic_settings[] = {
	{
		.freq_plan = 8000,
		.osr = 256,
		.actions = sky_record_imic_8KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_record_imic_8KHz_osr256_actions),
	},
	{
		.freq_plan = 16000,
		.osr = 256,
		.actions = sky_record_imic_16KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_record_imic_16KHz_osr256_actions),
	},
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_record_imic_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_record_imic_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_record_imic_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = sky_record_imic_settings,
	.setting_sz = ARRAY_SIZE(sky_record_imic_settings),
};

static enum hsed_controller sky_record_imic_pmctl_id[] = {PM_HSED_CONTROLLER_0};

static struct snddev_icodec_data sky_record_snddev_imic_data = {
	.capability = (SNDDEV_CAP_TX | SNDDEV_CAP_VOICE),
	.name = "sky_record_handset_tx", 
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_MIC, 
	.profile = &sky_record_imic_profile,
	.channel_mode = 1,
	.pmctl_id = sky_record_imic_pmctl_id,
	.pmctl_id_sz = ARRAY_SIZE(sky_record_imic_pmctl_id),
	.default_sample_rate = 48000,
	.pamp_on = NULL,
	.pamp_off = NULL,
};

static struct platform_device sky_record_msm_imic_device = {
	.name = "snddev_icodec",
	.id = 28,
	.dev = { .platform_data = &sky_record_snddev_imic_data },
};


static struct adie_codec_action_unit sky_mute_rx_48KHz_osr256_actions[] =
	SKY_MUTE_RX_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_mute_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_mute_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_mute_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_mute_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = sky_mute_rx_settings,
	.setting_sz = ARRAY_SIZE(sky_mute_rx_settings),
};

static struct snddev_icodec_data sky_snddev_mute_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "sky_mute_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HANDSET_SPKR,
	.profile = &sky_mute_rx_profile,
	.channel_mode = 1,
	.pmctl_id = NULL,
	.pmctl_id_sz = 0,
	.default_sample_rate = 48000,
	.pamp_on = &sky_snddev_mute_rx_on, 
	.pamp_off = &sky_snddev_mute_rx_off,
	.max_voice_rx_vol[VOC_NB_INDEX] = 500,
...
static struct platform_device sky_mute_rx_device = {
	.name = "snddev_icodec",
	.id = 29,
	.dev = { .platform_data = &sky_snddev_mute_rx_data },
};


static struct adie_codec_action_unit sky_voice_ihs_stereo_rx_48KHz_osr256_actions[] =
	SKY_VOICE_HEADSET_STEREO_RX_LEGACY_48000_OSR_256;

static struct adie_codec_hwsetting_entry sky_voice_ihs_stereo_rx_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = sky_voice_ihs_stereo_rx_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(sky_voice_ihs_stereo_rx_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile sky_voice_ihs_stereo_rx_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = sky_voice_ihs_stereo_rx_settings,
	.setting_sz = ARRAY_SIZE(sky_voice_ihs_stereo_rx_settings),
};

static struct snddev_icodec_data sky_voice_snddev_ihs_stereo_rx_data = {
	.capability = (SNDDEV_CAP_RX | SNDDEV_CAP_VOICE),
	.name = "sky_voice_headset_rx",
	.copp_id = 0,
	.acdb_id = ACDB_ID_HEADSET_SPKR_MONO,
	.profile = &sky_voice_ihs_stereo_rx_profile,
	.channel_mode = 2,
	.default_sample_rate = 48000,
	.pamp_on = &sky_snddev_hsed_pamp_on,
	.pamp_off = &sky_snddev_hsed_pamp_off,
	.max_voice_rx_vol[VOC_NB_INDEX] = 600,
	.min_voice_rx_vol[VOC_NB_INDEX] = -900,
	.max_voice_rx_vol[VOC_WB_INDEX] = 600,
	.min_voice_rx_vol[VOC_WB_INDEX] = -900
...
static struct platform_device sky_voice_msm_ihs_stereo_rx_device = {
	.name = "snddev_icodec",
	.id = 30,
	.dev = { .platform_data = &sky_voice_snddev_ihs_stereo_rx_data },
};
#endif
...
static struct platform_device *snd_devices_surf[] __initdata = {
	...
	&msm_uplink_rx_device,
#ifdef CONFIG_SKY_SND_CTRL   
	&sky_vt_msm_ispeaker_rx_device,
	&sky_vt_msm_ispeaker_tx_device,
	&sky_record_msm_imic_device,
	&sky_mute_rx_device,
	&sky_voice_msm_ihs_stereo_rx_device,
#endif        	
};
...
#if defined(CONFIG_MACH_MSM8X55_EF18K) || defined(CONFIG_MACH_MSM8X55_EF30S) 
                machine_is_msm8x55_ef18k() || machine_is_msm8x55_ef30s() ||
#endif		
