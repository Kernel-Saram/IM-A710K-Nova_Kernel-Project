...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASSX)
extern struct cpufreq_governor cpufreq_gov_smartassx;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_smartassx)
