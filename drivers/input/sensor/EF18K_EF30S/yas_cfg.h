...
#define PANTECH_FEATURE_SENSOR // PS2.P12095 for modified YAMAHA release ver.
#define PANTECH_AVOID_DEADLOCK // PS2.P12095 for removal locks
//#define PANTECH_EARLY_SUSPEND_SENSOR_OFF // PS2.P12095 for sensors off early suspending
...
#define YAS_PROX_DRIVER_NONE                (-1)
#define YAS_PROX_DRIVER_APDS9900             (0)

#define YAS_LIG_DRIVER_NONE                (-1)
#define YAS_LIG_DRIVER_APDS9900             (0)
...
#define SENSOR_TYPE_GEOMAGNETIC		(2)
...
#if defined(CONFIG_EF18K_SENSORS_BMA150)
#define YAS_ACC_DRIVER                      (YAS_ACC_DRIVER_BMA150)
#define CONFIG_INPUT_YAS_ACCELEROMETER_POSITION 5
...
#if defined(CONFIG_EF18K_SENSORS_YAS529)
...
#if defined(CONFIG_EF18K_SENSORS_L3G4200D)
#define YAS_GYRO_DRIVER                     (YAS_GYRO_DRIVER_NONE)
#elif defined(CONFIG_EF30S_SENSORS_L3G4200D)
#define YAS_GYRO_DRIVER                     (YAS_GYRO_DRIVER_L3G4200D)
#define CONFIG_INPUT_YAS_GYROSCOPE_POSITION 7
#define CONFIG_INPUT_YAS_GYROSCOPE_INTERFACE 0 // 0:i2c / 1:spi
#undef CONFIG_INPUT_YAS_GYROSCOPE_INTERRUPT // defined:interruptible / undef:polling
#else
#define YAS_GYRO_DRIVER                     (YAS_GYRO_DRIVER_NONE)
#endif

#if defined(CONFIG_EF18K_SENSORS_APDS9900)
#define YAS_PROX_DRIVER                      (YAS_PROX_DRIVER_APDS9900)
#define YAS_LIG_DRIVER                      (YAS_LIG_DRIVER_NONE)
#elif  defined(CONFIG_EF30S_SENSORS_APDS9900)
#define YAS_PROX_DRIVER                      (YAS_PROX_DRIVER_APDS9900)
#define YAS_LIG_DRIVER                      (YAS_LIG_DRIVER_NONE)
#else
#define YAS_PROX_DRIVER                      (YAS_PROX_DRIVER_NONE)
#define YAS_LIG_DRIVER                      (YAS_LIG_DRIVER_NONE)
#endif
