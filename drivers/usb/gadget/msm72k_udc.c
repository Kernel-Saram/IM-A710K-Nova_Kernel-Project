...
#if defined(CONFIG_MACH_MSM8X55_EF18K) // FEATURE_SKY_CHARGER_USB
#define USB_WALLCHARGER_CHG_CURRENT 650
#else
...
#if defined(CONFIG_MACH_MSM8X55_EF18K) //FEATURE_SKY_CHARGER_USB
        return 450; //450mA for Intelligent-USB
#else        
	return bmaxpow;
#endif
}
...
#if defined(CONFIG_MACH_MSM8X55_EF18K) //#if (MODEL_ID == MODEL_EF18K) || (MODEL_ID == MODEL_EF18B)
	/* xsemiyas : qualcomm spoof disconnecting problem */
	atomic_set(&ui->configured, 0);
#endif
