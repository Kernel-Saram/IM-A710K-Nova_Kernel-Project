...
// 20110703 hskim_wifi for wifi rpc (pantech_debug.c) to read nv mac address 
        ...
        struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    if (count == size) {
        printk(KERN_ERR "%s: state=%ld, size=%d\n", __func__, state, size);
        ret = count;
...
// modifyed by ycyang 20110902 0666 --> 0660
...
// 20110703 hskim_wifi commented out for build error
//err_out2:
