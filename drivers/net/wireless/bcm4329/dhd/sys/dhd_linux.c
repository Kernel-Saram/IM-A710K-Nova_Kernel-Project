...
#if defined(CONFIG_WIFI_CONTROL_FUNC) //20110717 hskim_wifi for wifi malloc 
...
/* Contorl fw roaming */
uint dhd_roam = 1;  // 20110721 hskim_wifi for roam_patch
...
static int dhd_set_suspend(int value, dhd_pub_t *dhd)
{
	...
	char iovbuf[32];
	int bcn_li_dtim = 3;
#ifdef CONFIG_BCM4329_ROAM_ENABLE	// 20110721 hskim_wifi for roam_patch
	uint roamvar = 1;
...
{
#ifndef CONFIG_BCM4329_PT_PATCH
...
#ifdef CONFIG_BCM4329_PT_PATCH // 20110721 hskim_wifi for suspend issue
...
extern void *wifi_mem_prealloc(int section, unsigned long size);
#endif
void * dhd_os_prealloc(int section, unsigned long size)
{
	...
	return 0;
#elif defined(CONFIG_BCM4329_MEM_PREALLOC)
	void *alloc_ptr = wifi_mem_prealloc(section, size);
	if (alloc_ptr)
	{
		DHD_INFO(("success alloc section %d\n", section));
		bzero(alloc_ptr, size);
