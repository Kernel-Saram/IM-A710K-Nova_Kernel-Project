...
#ifdef DBG_TIMESTAMP_ENABLE
#define dbgt(fmt, args...)   printk("[VIBDRV] " fmt, ##args)
#else
#define dbgt(fmt, args...)
#endif

#define FEATURE_LEVEL_CONTROL // shpark
